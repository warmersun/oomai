...
async def core_x_search(xai_client: AsyncClient, prompt: str, included_handles: Optional[List[str]] = None, last_24hrs: Optional[bool] = False, system_prompt:Optional[str] = None) -> str: 
